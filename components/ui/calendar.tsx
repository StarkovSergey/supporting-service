    ...
    <DayPicker
      ...
      components={{
        ...
        Dropdown: (dropdownProps) => {
          ...
          const { fromYear, fromMonth, fromDate, toYear, toMonth, toDate } = useDayPicker() // возвращает все пропсы, которые передаются в компонент

          let selectValues: Array<{ value: string; label: string }> = []
